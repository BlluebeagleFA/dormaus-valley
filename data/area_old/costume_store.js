{
   ...
   "events":[
      {
         "id":"ritter_festival_m",
         "title":"Spend the Festival With Ritter",
         "subtitle":"Ritter is lounging on the edge of the costume stall, drinking from a bottle. He doesn't look particularly festive.",
         "type":"random",
         "requirements":[
            {
         ...
         "results":{
            "success":{
               "text":"You approach the cat magician carefully. His legs swing idly on the side of the stall, and he shoots you a bored glance. \"Shop's closed. Festival, or whatever\", he mutters.</p>You ask him whether he would like to walk out through the festival with you then if he's closing up anyway. He glares at you, then chuckles. \"Alright, fair, I guess you logic-trapped me with that one. Come on then, there might be free booze.\"</p>He jumps down from his stall and walks off towards the food stands, without waiting to see if you join him. You tag along behind quickly.</p>With the festival in full swing, the market square and the fountain plaza are decked out in colours and lights. Red lanterns are hung from the eaves of buildings, and candles in red glass holders have been placed all around the fountain edge. Drapes of red cloth are hung across rooftops, turning all of the streets into makeshift tents.</p>Somehow, between walking from his stall to the fountain, Ritter has already found two bottles of wine. He takes a drink from one, then lifts out his hand with the other, but then drinks from that too instead of giving it to you.</p>\"They really take this stuff seriously, don't they? I don't really get it, I think. If anyone asks, this is a costume, and I'm really a hedgehog\", he says. You sit down beside him at the edge of the fountain and watch the crowds walk by. There are a lot of costumes this year. A bear painted with patchwork dye to make him look stitched-together, a fox with a long cloak and fake fangs, and countless people in red capes and masks. \"It's still weird to me, seeing so many people revelling. We never had anything like this at the tower. Just lessons, tests, and boring old men\", Ritter says.</p>His bored glance suddenly becomes more focused, and you follow his line of sight across the plaza to see another passer-by in a red cloak. The person turns to take a treat from a table, and you realise it is Saberhagen, wearing a costume. There is someone else at the table too, and their hands touch as they both reach for the same cake. Saberhagen steps back bashfully. \"Ah, you can have it! There are plenty of other things I'd love to try here!\", He chirps. The tall, dark-robed figure pulls back his hood to reveal a powerful, snarling tiger's head. Saberhagen steps back slightly. \"I would never eat something tainted by your touch, tower abomination\", the tiger growls. He then stalks away, leaving Saberhagen nervously clutching his collar. You hear a grinding, squeaking sound, and you turn to see that Ritter's claws are out, and they are leaving white scratch grooves in the glass of the bottle he is holding. His eyes narrow. \"You know, suddenly I am feeling the festive spirit after all. What is the tradition again? If you don't take a treat, you get a trick?\", he says.</p>He stands and begins quickly weaving his way through the crowd. You struggle to keep up with him at first, but soon you start to leave the crowded plaza and move towards the alleyways. Ritter moves like a shadow, following the hooded tiger from a distance. As you begin to close in, the tiger suddenly whips around, revealing a long blade in his hand. \"A tower beast is no match for a natural warrior, an abomination. I do not fear you\", the tiger hisses. Ritter looks unimpressed. \"Perhaps you should\", he says. The tiger lurches and gasps, his knee sinking down into the ground and his blade falling and sliding along the floor. The shadow beneath his feet is darkening and transforming into a thick, deep puddle, and he struggles to pull free of it.</p>Ritter's hands begin to glow with a green, sickly light. The new illumination scatters the shadows away, leaving the tiger sprawled on the floor as he now struggles and gasps from a ring of green light around his neck, squeezing and choking him. \"I may not have the privilege of 'natural' education, but a tower upbringing has a few perks\", Ritter says. \"For example, a large library of forbidden magic. Have you heard of the dracolich, Kalventis? He was laid to rest near here, actually. His greatest, final spell was locked away in our deepest archives. The spell...\"</p>Ritter raises his hand, and slowly starts to clench his fist. The light around the tiger's neck solidifies, becoming a green metal collar. Shackles appear around his wrists and ankles, and his eyes begin to glow as he thrashes and struggles.</p>\"...of Mastery\", Ritter finishes. He clenches his fist completely, and you feel a terrible, crushing and breaking sensation from the air around you. The tiger goes stiff, his eyes completely white, and falls limply onto the floor.</p>The eldritch light fades. Slowly, the tiger rises to his knees and gazes at Ritter with meek, worshipful subservience. \"How may I serve you, Master?\", he asks.</p>Ritter grins widely, his eyes large and excited. He sits down on one of the wooden crates stacked against the side of the alleyway and tugs off his boots with a yank on the sole. Ritter wiggles his soft furry toes and glares imperiously at the tiger. \"Come here, slave, and worship my feet\", he commands. The once-proud tiger crawls over on all fours and takes Ritter's paw in one of his massive hands. He raises it to his powerful muzzle, and slowly licks his long tongue across the soft sole, before lapping and kissing at his toes. \"Thank you, Master! You are so glorious and perfect. The ultimate feline. I am honoured to have the chance to kiss and serve and obey you\", he purrs.</p>Ritter reaches down and pulls the tiger up by tugging on his jerkin. The massive cat presses adoringly against Ritter's chest, as he pulls on the tiger's jerkin and tugs it up over his head. The tiger's torso is massive and muscular and crisscrossed with battle scars. \"Strip, slave. You will no longer wear clothes. You are nothing but an inferior beast\", Ritter says with a wicked smile. The tiger nods eagerly and pulls on his belt buckle before shoving down his pants. He pulls off his boots and tosses them aside with the rest of his clothes, leaving his muscular body naked without a hint of shame. Ritter strokes his hand along the tiger's side as he rubs and feels his firm muscles. He then wraps his hand around the tiger's gigantic, furry balls. The tiger grunts, his cock twitching and bouncing slightly, as Ritter starts to grip and squeeze. The tiger's expression slowly becomes pained, and he begins to whimper, his fingers twitching. Despite that, he makes no move to resist or fight back.</p>\"Fascinating. It works better than I dared to imagine. No wonder this spell was forbidden. Still, I have no particular interest in having to feed an ungrateful tiger\", Ritter says. He slaps the larger cat on the chest and points to you. \"This adventurer is your master now. You will obey and worship them as if they were me\", he commands.</p>Ritter pushes the tiger over to you and looks at you with interest. \"You felt that, didn't you? I saw you react when I activated the spell. There are not many people sensitive enough to detect mana flow in that way. You know, I think there may be something interesting in this town after all\", he says. He walks away, and leaves you with the tiger rubbing and nuzzling against your leg like an eager pet kitten.",
               "outcomes":[
                  {
                     "parameter":"festival_time",
                     "quantity":0,
